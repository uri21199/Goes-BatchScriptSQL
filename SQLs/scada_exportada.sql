...
Begin 
EXECUTE format(
           'COPY stage_scada_exportada FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/66e4ebde-07be-11eb-8c92-42010afa015a/events?&start_date=%sT%sZ"''',
           startdate, starttime
        );
END $$ ;
...
Begin 
EXECUTE format(
           'COPY stage_scada_exportada FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/c62ae0c8-0816-11eb-aeeb-42010afa015a/events?&start_date=%sT%sZ"''',
           startdate, starttime
        );
END $$ ;
INSERT INTO stage_scada_exportada2 select f.* from stage_scada_exportada, jsonb_populate_recordset(null::stage_scada_exportada2, x) f;
...
Begin 
EXECUTE format(
           'COPY stage_scada_exportada FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/676a0fc6-0809-11eb-8a43-42010afa015a/events?&start_date=%sT%sZ"''',
           startdate, starttime
        );
END $$ ;
INSERT INTO stage_scada_exportada2 select f.* from stage_scada_exportada, jsonb_populate_recordset(null::stage_scada_exportada2, x) f;
...
Begin 
EXECUTE format(
           'COPY stage_scada_exportada FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/8acddc7c-0809-11eb-8564-42010afa015a/events?&start_date=%sT%sZ"''',
           startdate, starttime
        );
END $$ ;
INSERT INTO stage_scada_exportada2 select f.* from stage_scada_exportada, jsonb_populate_recordset(null::stage_scada_exportada2, x) f;
...
Begin 
EXECUTE format(
           'COPY stage_scada_exportada_caf FROM PROGRAM ''curl -H "Api-Key:e385a1a5-0441-4e06-be58-162731a7d4f9.01" "https://portal.unity.inaccess.com/ifms/sources/fb2dca56-f33f-11ea-83ff-42010afa015a/events?&start_date=%sT%sZ"''',
           startdate, starttime
        );
END $$ ;
