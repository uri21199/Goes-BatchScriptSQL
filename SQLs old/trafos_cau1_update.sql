DELETE FROM caupotenciatrafos_cau1fv WHERE date >= now() - interval '20 minutes';
...
INSERT INTO caupotenciatrafos_cau1fv SELECT * from stage_trafos_cau12 WHERE date >= (now()::timestamptz - interval '20 minutes');
DROP TABLE IF EXISTS stage_trafos_cau1;
DROP TABLE IF EXISTS stage_trafos_cau12;
