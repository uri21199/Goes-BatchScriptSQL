...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/9dbe91f7-1dfe-4b1a-bc5e-c70fea655af4/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/691e6d91-3f18-490e-80fd-45680a5a61d4/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/b82ea7ce-7f07-476b-9153-b84c690f3fbf/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/c62977d8-0816-11eb-aeeb-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/67685e10-0809-11eb-8a43-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/8acca398-0809-11eb-8564-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/607234a6-07f9-11eb-aeeb-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/c3bb19d6-07ec-11eb-8a43-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/18e60db2-07ed-11eb-8564-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/7fb8f65c-29bd-11eb-a0f9-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/142c54ac-298f-11eb-9edf-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/67593d54-28ed-11eb-b18a-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/608f4776-07f9-11eb-aeeb-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/c3d79778-07ec-11eb-8a43-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
...
declare startdate text := to_char(current_date - 1, 'YYYYMMDD'); 
-- Se genera un bloque de codigo para cargar datos en stage_caf_potencia_72hs desde la url dada
Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" "https://portal.unity.inaccess.com/ifms/sources/19024cac-07ed-11eb-8564-42010afa015a/events?&start_date=%sT000000Z"''',startdate);
End$$ ;
-- Se cargan campos dentro stage_caf_potencia_72hs2 que vienen de una subconsulta a stage_caf_potencia_72hs y a la vez se actualizacion campos
