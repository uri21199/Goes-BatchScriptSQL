...
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/1851c03a-07ed-11eb-8564-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE powercau3 SET powercau3 = powercau3 / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
...
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/c62ae0c8-0816-11eb-aeeb-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE eecau1 SET eecau1val = eecau1val / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagey;
------------------------------Energy exported CAU2------------------------------
DROP TABLE IF EXISTS eecau2;
CREATE TABLE eecau2 (date timestamptz, val numeric);
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/676a0fc6-0809-11eb-8a43-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE eecau2 SET eecau2val = eecau2val / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagey;
------------------------------Energy exported CAU3------------------------------
DROP TABLE IF EXISTS eecau3;
CREATE TABLE eecau3 (date timestamptz, val numeric);
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/8acddc7c-0809-11eb-8564-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE eecau3 SET eecau3val = eecau3val / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagey;
--------------------availcau1-------------------------
DROP TABLE IF EXISTS availcau1;
CREATE TABLE availcau1 (date timestamptz, val numeric);
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/9dbe91f7-1dfe-4b1a-bc5e-c70fea655af4/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/691e6d91-3f18-490e-80fd-45680a5a61d4/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/b82ea7ce-7f07-476b-9153-b84c690f3fbf/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/c62977d8-0816-11eb-aeeb-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE poicau1 SET poicau1 = poicau1 / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagey;
--------------------poicau2-------------------------
DROP TABLE IF EXISTS poicau2;
CREATE TABLE poicau2 (date timestamptz, val numeric);
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/67685e10-0809-11eb-8a43-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE poicau2 SET poicau2 = poicau2 / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagey;
--------------------poicau3-------------------------
DROP TABLE IF EXISTS poicau3;
CREATE TABLE poicau3 (date timestamptz, val numeric);
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/8acca398-0809-11eb-8564-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE poicau3 SET poicau3 = poicau3 / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagey;
------------------powercau1----------------------------
DROP TABLE IF EXISTS powercau1;
CREATE TABLE powercau1 (date timestamptz, val numeric);
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/5fea3ca4-07f9-11eb-aeeb-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE powercau1 SET powercau1 = powercau1 / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagey;
------------------powercau2----------------------------
DROP TABLE IF EXISTS powercau2;
CREATE TABLE powercau2 (date timestamptz, val numeric);
create temp table stagey(x jsonb);
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagey FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/c320449c-07ec-11eb-8a43-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE powercau2 SET powercau2 = powercau2 / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagey;
...
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/607234a6-07f9-11eb-aeeb-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
CREATE TEMP TABLE stagex(x jsonb) ;
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/c3bb19d6-07ec-11eb-8a43-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
CREATE TEMP TABLE stagex(x jsonb) ;
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/18e60db2-07ed-11eb-8564-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
CREATE TEMP TABLE stagex(x jsonb) ;
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/7fb8f65c-29bd-11eb-a0f9-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
CREATE TEMP TABLE stagex(x jsonb) ;
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/142c54ac-298f-11eb-9edf-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
CREATE TEMP TABLE stagex(x jsonb) ;
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/67593d54-28ed-11eb-b18a-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
CREATE TEMP TABLE stagex(x jsonb) ;
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/608f4776-07f9-11eb-aeeb-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE rpcau1 SET rpcau1 = rpcau1 / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagex;
...
CREATE TEMP TABLE stagex(x jsonb) ;
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/c3d79778-07ec-11eb-8a43-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE rpcau2 SET rpcau2 = rpcau2 / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagex;
...
CREATE TEMP TABLE stagex(x jsonb) ;
Do $$ declare startdate text := to_char(current_date - 3, 'YYYYMMDD'); Begin EXECUTE format('COPY stagex FROM PROGRAM ''curl "https://portal.unity.inaccess.com/ifms/sources/19024cac-07ed-11eb-8564-42010afa015a/events?apiKey=38deaa51-8716-4cc9-aa42-ab14fb72a752.01&start_date=%sT000000Z"''',startdate);End$$ ;
...
UPDATE rpcau3 SET rpcau3 = rpcau3 / 1000 WHERE date >= now() - interval '3 days' AND date <= CURRENT_TIMESTAMP;
DROP TABLE IF EXISTS stagex;
...
UPDATE public.caucharidatabasehf SET eecau1val = eecau1.eecau1val FROM public.eecau1 WHERE public.eecau1.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET eecau2val = eecau2.eecau2val FROM public.eecau2 WHERE public.eecau2.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET eecau3val = eecau3.eecau3val FROM public.eecau3 WHERE public.eecau3.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET availcau1 = availcau1.availcau1 FROM public.availcau1 WHERE public.availcau1.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET availcau2 = availcau2.availcau2 FROM public.availcau2 WHERE public.availcau2.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET availcau3 = availcau3.availcau3 FROM public.availcau3 WHERE public.availcau3.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET poicau1 = poicau1.poicau1 FROM public.poicau1 WHERE public.poicau1.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET poicau2 = poicau2.poicau2 FROM public.poicau2 WHERE public.poicau2.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET poicau3 = poicau3.poicau3 FROM public.poicau3 WHERE public.poicau3.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET powercau1 = powercau1.powercau1 FROM public.powercau1 WHERE public.powercau1.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET powercau2 = powercau2.powercau2 FROM public.powercau2 WHERE public.powercau2.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET powercau3 = powercau3.powercau3 FROM public.powercau3 WHERE public.powercau3.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;

UPDATE public.caucharidatabasehf SET lvcau1 = lvcau1.lvcau1 FROM public.lvcau1 WHERE public.lvcau1.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET lvcau2 = lvcau2.lvcau2 FROM public.lvcau2 WHERE public.lvcau2.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET lvcau3 = lvcau3.lvcau3 FROM public.lvcau3 WHERE public.lvcau3.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET freccau1 = freccau1.freccau1 FROM public.freccau1 WHERE public.freccau1.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET freccau2 = freccau2.freccau2 FROM public.freccau2 WHERE public.freccau2.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET freccau3 = freccau3.freccau3 FROM public.freccau3 WHERE public.freccau3.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET rpcau1 = rpcau1.rpcau1 FROM public.rpcau1 WHERE public.rpcau1.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET rpcau2 = rpcau2.rpcau2 FROM public.rpcau2 WHERE public.rpcau2.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
UPDATE public.caucharidatabasehf SET rpcau3 = rpcau3.rpcau3 FROM public.rpcau3 WHERE public.rpcau3.date = caucharidatabasehf.date AND caucharidatabasehf.date >= now() - interval '3 days' AND caucharidatabasehf.date <= CURRENT_TIMESTAMP;
...
DELETE FROM caupotenciatrafos_cau1fv WHERE date >= now() - interval '3 days';
...
INSERT INTO caupotenciatrafos_cau1fv SELECT * from stage_trafos_cau12 WHERE date >= (now()::timestamptz - interval '3 days');
DROP TABLE IF EXISTS stage_trafos_cau1;
DROP TABLE IF EXISTS stage_trafos_cau12;
...
DELETE FROM caupotenciatrafos_cau2fv WHERE date >= now() - interval '3 days';
...
INSERT INTO caupotenciatrafos_cau2fv SELECT * from stage_trafos_cau22 WHERE date >= (now()::timestamptz - interval '3 days');
DROP TABLE IF EXISTS stage_trafos_cau2;
DROP TABLE IF EXISTS stage_trafos_cau22;
...
DELETE FROM caupotenciatrafos_cau3fv WHERE date >= now() - interval '3 days';
...
INSERT INTO caupotenciatrafos_cau3fv SELECT * from stage_trafos_cau32 WHERE date >= (now()::timestamptz - interval '3 days');
DROP TABLE IF EXISTS stage_trafos_cau3;
DROP TABLE IF EXISTS stage_trafos_cau32;
