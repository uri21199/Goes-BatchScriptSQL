...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\6.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\7.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\8.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\9.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\10.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\11.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\12.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\13.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\14.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
...
COPY tmp_ocr_cau 
FROM 'C:\Users\Administrador\Desktop\bmem\Cauchari AM - BD para importar - no tocar\import\15.csv'
DELIMITER ';' NULL AS 'nan'
CSV HEADER ;
ALTER TABLE tmp_ocr_cau DROP COLUMN n;
INSERT INTO bmem.cauchari_resumen SELECT * from tmp_ocr_cau ON CONFLICT ON CONSTRAINT uc_cauchari_resumen DO NOTHING;
