...
CREATE TEMP TABLE stage_json_cau (id INT DEFAULT NEXTVAL('seq_temp_json'::regclass), json TEXT); 
CREATE TEMP TABLE stage_forecast_power_cauchari (x jsonb);
-- Copia los datos extraidos de la URL dada
COPY stage_json_cau(json) FROM PROGRAM 'curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" -H "Accept: application/json" -H "Authorization: Bearer QbkFB-yEJmIS5EikH7j_DCVbWVih1mM1" "https://api.solcast.com.au/utility_scale_sites/30ad-0a5e-3313-528a/forecasts?period=PT30M&format=json"';
-- Insertar datos
...
-- Copia los datos extraidos de la URL dada
COPY stage_json_cau(json) FROM PROGRAM 'curl -H "Api-Key:38deaa51-8716-4cc9-aa42-ab14fb72a752.01" -H "Accept: application/json" -H "Authorization: Bearer QbkFB-yEJmIS5EikH7j_DCVbWVih1mM1" "https://api.solcast.com.au/utility_scale_sites/30ad-0a5e-3313-528a/weather/forecasts?period=PT30M&format=json"';
-- Insertar datos
